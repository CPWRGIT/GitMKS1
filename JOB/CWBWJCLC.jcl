//CWEZXXXX JOB (MMC),'COBOL TEST',CLASS=L,
//  MSGCLASS=X,MSGLEVEL=(1,1),NOTIFY=CWEZXXX                            00020002
//*                                                                     00000203
//*JOBPARM S=CWCC
//* *******************************************************************
//*
...
//*  =============
//*
//*  1) C ALL TXXX      TO YOUR APPLICATION CODE
//*  2) C ALL #LVL      TO THE LEVEL YOUR PROGRAM IS CURRENTLY AT
//*  3) C ALL CWEZXXX   TO YOUR USERID
...
//         DD   DISP=SHR,DSN=SALESSUP.TXXX.#LVL.LOAD
